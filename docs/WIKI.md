...
| W32 | **Q2_0 ARM NEON repack kernels shipped** | CPU-only prefill 4.04 -> 15.76 tok/s (**3.90x**), decode 3.28 -> 5.08 (1.55x); validated vs ggml's own generic, greedy output character-identical | pending |
